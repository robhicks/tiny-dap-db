...
var utc = () => Date.now();
var Vertex = class {
  constructor(path2, store2, socket) {
...
// src/tests/Vertex.network.spec.ts
...
describe.only("Vertex-network interactions", () => {
  ...
  before(() => {
    ...
    wsc = new WebSocketClient_default(fakeUrl);
    store = new MemoryStore();
    v = new Vertex_default(path, store, wsc);
    vertices_default.set(path, v);
